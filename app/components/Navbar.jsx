...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
    ...
    const sideMMenuRef = useRef();

    const openMenu = () => {
        sideMMenuRef.current.style.transform = 'translateX(-16rem)';
    }
    const closeMenu = () => {
        sideMMenuRef.current.style.transform = 'translateX(16rem)';
    ...
    return (
        <>
            ...
            cursor-pointer mr-14' />
                ...
                <ul ref={sideMMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64  top-0  bottom-0  w-64 z-50 h-screen bg-rose-50 transition duration-500'>
